...
export default function Indispensable() {
  return (
    <section className="px-4 sm:px-8 md:px-16 lg:px-24 py-24 w-full text-center bg-white">
      <div className="max-w-6xl mx-auto space-y-8">
        <h2
          className={`${dmSerif.className} text-3xl sm:text-5xl font-bold leading-tight`}
        >
      ...
      <ul className="mt-16 grid grid-cols-1 sm:grid-cols-2 gap-12 max-w-6xl mx-auto">
        <li className="flex flex-col items-center  text-center  gap-4">
          ...
          />
          <h3 className="text-xl font-semibold">Crédibilité instantanée</h3>
          <p>
        ...
        <li className="flex flex-col items-center text-center  gap-4">
          ...
          />
          <h3 className="text-xl font-semibold ">Visibilité permanente</h3>
          <p>
        ...
        <li className="flex flex-col items-center  text-center gap-4">
          ...
          />
          <h3 className="text-xl font-semibold">Acquisition directe</h3>
          <p>
        ...
        <li className="flex flex-col items-center  text-center  gap-4">
          ...
          />
          <h3 className="text-xl font-semibold">Maîtrise de votre image</h3>
          <p>
